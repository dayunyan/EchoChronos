from mindnlp.transformers import Qwen2Config, Qwen2PreTrainedModel
from mindnlp.transformers import Qwen2Model
from mindspore import nn, ops


class Qwen2ForSeq2Seq(Qwen2PreTrainedModel):
